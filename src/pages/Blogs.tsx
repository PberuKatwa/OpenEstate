        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <div className="w-7 h-7 rounded-lg bg-rose-50 flex items-center justify-center">
              <FontAwesomeIcon icon={faNewspaper} className="w-3.5 h-3.5 text-rose-700" />
            </div>
            <span className="text-[10px] font-semibold text-rose-700 uppercase tracking-[0.2em]">
              Content
            </span>
          </div>
          <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">Blog Posts</h1>
          <p className="text-sm text-gray-400 mt-1">Manage and publish your articles</p>
        </div>
