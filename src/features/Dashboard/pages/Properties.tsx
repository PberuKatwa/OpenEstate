  ...
  return (
    ...
    <div className="flex-row min-h-screen">
      ...
      <div className="inline-flex rounded-base shadow-xs -space-x-px m-2" role="group">
        <button type="button" className="inline-flex items-center text-body border border-default hover:bg-neutral-secondary-medium
          hover:text-heading focus:ring-3 focus:ring-neutral-tertiary-soft font-medium leading-5 rounded-s-base text-sm px-3 py-2 focus:outline-none">
